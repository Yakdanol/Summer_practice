...
//
            ...
            */
            ...
            try
            {
                Student student1 = new Student("Yakukhin", "Danila", "Olegovich", "M8О-213Б-21", Student.Course.Cs);
                Console.WriteLine(student1.ToString());
                Console.WriteLine(student1.SurnameValue);
                Console.WriteLine(student1.NameValue);
                Console.WriteLine(student1.PatronymicValue);
                Console.WriteLine(student1.StudyGroupValue);
                Console.WriteLine(student1.CourseValue);
                Console.WriteLine($"Номер курса по группе: {student1.GetCourseNumber}");

                Console.WriteLine($"Hash code: {student1.GetHashCode()}");

                Student student2 = new Student("Ivanov", "Ivan", "Ivanovic", "М8О-211Б-21", Student.Course.Yandex);
                Console.WriteLine($"{Environment.NewLine}{student2.ToString()}");
                
                Console.WriteLine($"Проверка на равенство двух студентов: {student1.Equals(student2)}");
                Console.WriteLine($"Проверка на равенство двух студентов c object: {student1.Equals((object)student2)}");
